...
public class RectangleSet {
	...
	public static List<Obstacle> getStage1(){
		...
		int[] spaces = {0,50,200+100,250+100,50,400};
		...
		Rectangle bad_food1 = new Rectangle(rec1_4.getX()+500,rec1_4.getY()-180,80,80);
		...
		obs.add(new Obstacle(l1,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(l2,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(l3,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(l4,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(l5,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(l6,"res/brick.jpg",Obstacle.PLATFORM));
	...
	public static List<Obstacle> getStage2(){
		...
		Rectangle rec1_1 = new Rectangle(1000, 500, 200, 50);
		Rectangle rec1_2 = new Rectangle(1200, 450, 200, 50);
		Rectangle rec1_3 = new Rectangle(1400, 400, 200, 50);
		recs_1.add(rec1_1);
		recs_1.add(rec1_2);
		recs_1.add(rec1_3);
		...
		Rectangle rec2_1 = new Rectangle(1400+500, 200, 200, 250);
		recs_2.add(rec2_1);
		
		//obstacle 3
		List<Rectangle> recs_3 = new ArrayList<Rectangle>();
		Rectangle rec3_1 = new Rectangle(rec2_1.getX()+rec2_1.getWidth()+350, 400, 200, 150);
		recs_3.add(rec3_1);
		...
		Rectangle rec5_1 = new Rectangle(rec4_1.getX()+rec4_1.getWidth()+200+50, 0, 50, 150);
		Rectangle rec5_2 = new Rectangle(rec4_1.getX()+rec4_1.getWidth()+100+50, 300, 200, 50);
		recs_5.add(rec5_1);
		recs_5.add(rec5_2);
		
		
		Rectangle good_food1 = new Rectangle(rec1_1.getX()+30+50,rec1_1.getY()-200,80,80);
		Rectangle bad_food1 = new Rectangle(rec4_1.getX()+30+50,rec4_1.getY()-200,80,80);
		...
		obs.add(new Obstacle(recs_1,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(recs_2,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(recs_3,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(recs_4,"res/brick.jpg",Obstacle.PLATFORM));
		obs.add(new Obstacle(recs_5,"res/brick.jpg",Obstacle.PLATFORM));
		return obs;
	}
		...
		//escalera
		Rectangle rec3_1 = new Rectangle(800, 510, 200, 100);
		Rectangle rec3_2 = new Rectangle(800, 470, 200, 140);
		Rectangle rec3_3 = new Rectangle(800, 430, 200, 180);
		Rectangle rec3_4 = new Rectangle(800, 390, 200, 220);
		Rectangle rec3_5 = new Rectangle(800, 350, 200, 260);
		Rectangle rec3_6 = new Rectangle(800, 310, 200, 300);
		

		//cosas puntudas
		Rectangle rec3_7 = new Rectangle(800, 520, 70, 30);
			
		//perro
		Rectangle rec3_8 = new Rectangle(800, 500, 65, 50);
		
		//gato
		Rectangle rec3_9 = new Rectangle(800, 500, 65, 50);
		...
		int [] spaces ={0,200+50,450,0,0,0,0,0,300,300}; 
